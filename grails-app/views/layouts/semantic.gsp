	...
	<body>
		<div class="ui segment">
			<div class="ui two column grid">
				...
				<div class="column" style="text-align: right;">
					<img class="ui image" style="max-height: 100px;display: inline-block;margin-top:5px;" src="https://s3.amazonaws.com/swblabs-content/images/swblabs.png" />				
				</div>
			</div>
		</div>
				...
				<div class="ui menu">
					...
					<sec:ifAllGranted roles="ROLE_ADMIN">
						<div class="ui dropdown item">
							...
							<div class="menu">
							   <a class="item" href="/admin/bbdemo">BoardBot Simulator</a>
							   <a class="item" href="/admin/bt">Bluetooth Status (By Device)</a>
							   <a class="item" href="/admin/bt2">Bluetooth Status (By Recency)</a>
		...
		<div class="menu-wrapper">
			<div class="ui segment" style="margin-bottom: 15px;">
				<b>Notify ${grailsApplication.metadata['app.version']}</b>
			</div>
		</div>
